...
@section('title', 'עריכת משתמש - CampusFix')
@section('page-title', 'עריכת משתמש')
                ...
                <form method="POST" action="{{ route('admin.users.update', $user) }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="identity_number" value="{{ old('identity_number', $user->identity_number) }}" class="form-control @error('identity_number') is-invalid @enderror">
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label">סיסמה חדשה <span class="text-muted small">(השאר ריק כדי לא לשנות)</span></label>
